...
I worked on various problems in commutative algebra involving graded rings and modules, Grobner basis, homological invariants, multiplicity and characteristic p methods. My most recent work proves that the Hilbert-Kunz multiplicity of Fermat quadrics decreases as the characteristic increases. The proof relies on the modular representation theory of cyclic p-groups and provides an explicit closed formula for the multiplicity as a function of both the characteristic and the dimension. In another recent work, I investigated the dimensions of the non‑projective summands in tensor powers of modular representations of finite p-groups. When the exponent varies, I have shown that the resulting dimension sequence can have a transcendental generating function, and I have given an algorithm to compute such generating functions in the Omega-algebraic case.<br><br>
